...
## The answer is janitor::tabyl()

--

but it's not 'flat file'... 
...
# 'pivot tables' fits nicely into the grammar of graphics framework 

--

## we might want tabular output rather than a rendered chart

--

## if it's 'tidy' this output should probably just be a dataframe/tibble
...
### Very big thanks to contributors Brian Shalloway and Shannon Pileggi!  And Hadley Wickham and tidyverse team. Leland Wilkinson for Grammar of Graphics framework.
